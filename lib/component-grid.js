...
var ComponentGrid = (_class = (_temp = _class2 = function (_React$Component2) {
  ...
  (0, _createClass3["default"])(ComponentGrid, [{
    ...
    value: function setChildWidth() {
      ...
      // HACK: Magic numbers, ain't nothing to it, rounding errors made me do it.
      var cw = Math.floor(this._container.clientWidth) - 1;
      ...
      var size = cw / count - margin + margin / count;
